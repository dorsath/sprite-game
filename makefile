...
DEBS=src/display.o src/program.o src/model.o src/background.o src/fbo.o src/object.o lib/Matrices.o src/slice.o src/octree.o src/polygon.o src/text.o src/font.o lib/lodepng.o src/sprite.o
